...
def findCommunites(headers, threshold):
    ...
    :param headers: list of Wikipedia pages names
    :param threshold: threshold in [0,1] for cosine similarity
    :return: list of lists, each is a community (partition of headers)
    """
...
with open("pop_CS_sports_DB", "r", encoding='utf-8') as f1:
    lines = f1.read().splitlines()
print(findCommunites(lines, 0.1))
